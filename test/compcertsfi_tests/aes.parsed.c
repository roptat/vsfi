...
int rijndaelKeySetupEnc(u32 * rk, u8 const * cipherKey, int keyBits)
{
  int i;
  u32 temp;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:729");
  i = 0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:730");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:732");
  rk[0] =
    (u32) cipherKey[0] << 24 ^ (u32) cipherKey[1] << 16
      ^ (u32) cipherKey[2] << 8 ^ (u32) cipherKey[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:733");
  rk[1] =
    (u32) (cipherKey + 4)[0] << 24 ^ (u32) (cipherKey + 4)[1] << 16
      ^ (u32) (cipherKey + 4)[2] << 8 ^ (u32) (cipherKey + 4)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:734");
  rk[2] =
    (u32) (cipherKey + 8)[0] << 24 ^ (u32) (cipherKey + 8)[1] << 16
      ^ (u32) (cipherKey + 8)[2] << 8 ^ (u32) (cipherKey + 8)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:735");
  rk[3] =
    (u32) (cipherKey + 12)[0] << 24 ^ (u32) (cipherKey + 12)[1] << 16
      ^ (u32) (cipherKey + 12)[2] << 8 ^ (u32) (cipherKey + 12)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:736");
  if (keyBits == 128) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:737");
    for (/*nothing*/; 1; /*nothing*/) {
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:738");
      temp = rk[3];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:739");
      rk[4] =
        rk[0] ^ Te4[temp >> 16 & 0xff] & 0xff000000
          ^ Te4[temp >> 8 & 0xff] & 0x00ff0000
          ^ Te4[temp & 0xff] & 0x0000ff00 ^ Te4[temp >> 24] & 0x000000ff
          ^ rcon[i];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:745");
      rk[5] = rk[1] ^ rk[4];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:746");
      rk[6] = rk[2] ^ rk[5];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:747");
      rk[7] = rk[3] ^ rk[6];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:748");
      if (++i == 10) {
        __builtin_debug(6, "", 1);
        __builtin_debug(1, "#line:aes.c:749");
        return 10;
      }
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:751");
      rk += 4;
    }
  }
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:754");
  rk[4] =
    (u32) (cipherKey + 16)[0] << 24 ^ (u32) (cipherKey + 16)[1] << 16
      ^ (u32) (cipherKey + 16)[2] << 8 ^ (u32) (cipherKey + 16)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:755");
  rk[5] =
    (u32) (cipherKey + 20)[0] << 24 ^ (u32) (cipherKey + 20)[1] << 16
      ^ (u32) (cipherKey + 20)[2] << 8 ^ (u32) (cipherKey + 20)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:756");
  if (keyBits == 192) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:757");
    for (/*nothing*/; 1; /*nothing*/) {
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:758");
      temp = rk[5];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:759");
      rk[6] =
        rk[0] ^ Te4[temp >> 16 & 0xff] & 0xff000000
          ^ Te4[temp >> 8 & 0xff] & 0x00ff0000
          ^ Te4[temp & 0xff] & 0x0000ff00 ^ Te4[temp >> 24] & 0x000000ff
          ^ rcon[i];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:765");
      rk[7] = rk[1] ^ rk[6];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:766");
      rk[8] = rk[2] ^ rk[7];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:767");
      rk[9] = rk[3] ^ rk[8];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:768");
      if (++i == 8) {
        __builtin_debug(6, "", 1);
        __builtin_debug(1, "#line:aes.c:769");
        return 12;
      }
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:771");
      rk[10] = rk[4] ^ rk[9];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:772");
      rk[11] = rk[5] ^ rk[10];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:773");
      rk += 6;
    }
  }
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:776");
  rk[6] =
    (u32) (cipherKey + 24)[0] << 24 ^ (u32) (cipherKey + 24)[1] << 16
      ^ (u32) (cipherKey + 24)[2] << 8 ^ (u32) (cipherKey + 24)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:777");
  rk[7] =
    (u32) (cipherKey + 28)[0] << 24 ^ (u32) (cipherKey + 28)[1] << 16
      ^ (u32) (cipherKey + 28)[2] << 8 ^ (u32) (cipherKey + 28)[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:778");
  if (keyBits == 256) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:779");
    for (/*nothing*/; 1; /*nothing*/) {
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:780");
      temp = rk[7];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:781");
      rk[8] =
        rk[0] ^ Te4[temp >> 16 & 0xff] & 0xff000000
          ^ Te4[temp >> 8 & 0xff] & 0x00ff0000
          ^ Te4[temp & 0xff] & 0x0000ff00 ^ Te4[temp >> 24] & 0x000000ff
          ^ rcon[i];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:787");
      rk[9] = rk[1] ^ rk[8];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:788");
      rk[10] = rk[2] ^ rk[9];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:789");
      rk[11] = rk[3] ^ rk[10];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:790");
      if (++i == 7) {
        __builtin_debug(6, "", 1);
        __builtin_debug(1, "#line:aes.c:791");
        return 14;
      }
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:793");
      temp = rk[11];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:794");
      rk[12] =
        rk[4] ^ Te4[temp >> 24] & 0xff000000
          ^ Te4[temp >> 16 & 0xff] & 0x00ff0000
          ^ Te4[temp >> 8 & 0xff] & 0x0000ff00
          ^ Te4[temp & 0xff] & 0x000000ff;
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:799");
      rk[13] = rk[5] ^ rk[12];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:800");
      rk[14] = rk[6] ^ rk[13];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:801");
      rk[15] = rk[7] ^ rk[14];
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:aes.c:803");
      rk += 8;
    }
  }
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:806");
  return 0;
}

int rijndaelKeySetupDec(u32 * rk, u8 const * cipherKey, int keyBits)
{
  int Nr;
  int i;
  int j;
  u32 temp;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:815");
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:816");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:819");
  Nr = rijndaelKeySetupEnc(rk, cipherKey, keyBits);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:821");
  for (__builtin_debug(6, "", 1), (i = 0, j = 4 * Nr);
       i < j;
       __builtin_debug(6, "", 1), (i += 4, j -= 4)) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:822");
    temp = rk[i];
    __builtin_debug(6, "", 1);
    rk[i] = rk[j];
    __builtin_debug(6, "", 1);
    rk[j] = temp;
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:823");
    temp = rk[i + 1];
    __builtin_debug(6, "", 1);
    rk[i + 1] = rk[j + 1];
    __builtin_debug(6, "", 1);
    rk[j + 1] = temp;
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:824");
    temp = rk[i + 2];
    __builtin_debug(6, "", 1);
    rk[i + 2] = rk[j + 2];
    __builtin_debug(6, "", 1);
    rk[j + 2] = temp;
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:825");
    temp = rk[i + 3];
    __builtin_debug(6, "", 1);
    rk[i + 3] = rk[j + 3];
    __builtin_debug(6, "", 1);
...
void rijndaelEncrypt(u32 const * rk, int Nr, u8 const * pt, u8 * ct)
{
  ...
  int r;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:855");
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  ...
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:857");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:864");
  s0 =
    (u32) pt[0] << 24 ^ (u32) pt[1] << 16 ^ (u32) pt[2] << 8 ^ (u32) pt[3]
      ^ rk[0];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:865");
  s1 =
    (u32) (pt + 4)[0] << 24 ^ (u32) (pt + 4)[1] << 16
      ^ (u32) (pt + 4)[2] << 8 ^ (u32) (pt + 4)[3] ^ rk[1];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:866");
  s2 =
    (u32) (pt + 8)[0] << 24 ^ (u32) (pt + 8)[1] << 16
      ^ (u32) (pt + 8)[2] << 8 ^ (u32) (pt + 8)[3] ^ rk[2];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:867");
  s3 =
    (u32) (pt + 12)[0] << 24 ^ (u32) (pt + 12)[1] << 16
      ^ (u32) (pt + 12)[2] << 8 ^ (u32) (pt + 12)[3] ^ rk[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:943");
  r = Nr >> 1;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:944");
  for (/*nothing*/; 1; /*nothing*/) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:945");
    t0 =
      Te0[s0 >> 24] ^ Te1[s1 >> 16 & 0xff] ^ Te2[s2 >> 8 & 0xff]
        ^ Te3[s3 & 0xff] ^ rk[4];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:951");
    t1 =
      Te0[s1 >> 24] ^ Te1[s2 >> 16 & 0xff] ^ Te2[s3 >> 8 & 0xff]
        ^ Te3[s0 & 0xff] ^ rk[5];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:957");
    t2 =
      Te0[s2 >> 24] ^ Te1[s3 >> 16 & 0xff] ^ Te2[s0 >> 8 & 0xff]
        ^ Te3[s1 & 0xff] ^ rk[6];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:963");
    t3 =
      Te0[s3 >> 24] ^ Te1[s0 >> 16 & 0xff] ^ Te2[s1 >> 8 & 0xff]
        ^ Te3[s2 & 0xff] ^ rk[7];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:970");
    rk += 8;
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:971");
    if (--r == 0) {
      break;
    }
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:975");
    s0 =
      Te0[t0 >> 24] ^ Te1[t1 >> 16 & 0xff] ^ Te2[t2 >> 8 & 0xff]
        ^ Te3[t3 & 0xff] ^ rk[0];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:981");
    s1 =
      Te0[t1 >> 24] ^ Te1[t2 >> 16 & 0xff] ^ Te2[t3 >> 8 & 0xff]
        ^ Te3[t0 & 0xff] ^ rk[1];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:987");
    s2 =
      Te0[t2 >> 24] ^ Te1[t3 >> 16 & 0xff] ^ Te2[t0 >> 8 & 0xff]
        ^ Te3[t1 & 0xff] ^ rk[2];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:993");
    s3 =
      Te0[t3 >> 24] ^ Te1[t0 >> 16 & 0xff] ^ Te2[t1 >> 8 & 0xff]
        ^ Te3[t2 & 0xff] ^ rk[3];
  }
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1005");
  s0 =
    Te4[t0 >> 24] & 0xff000000 ^ Te4[t1 >> 16 & 0xff] & 0x00ff0000
      ^ Te4[t2 >> 8 & 0xff] & 0x0000ff00 ^ Te4[t3 & 0xff] & 0x000000ff
      ^ rk[0];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1011");
  ct[0] = (u8) (s0 >> 24);
  __builtin_debug(6, "", 1);
  ct[1] = (u8) (s0 >> 16);
  __builtin_debug(6, "", 1);
  ...
  ct[3] = (u8) s0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1012");
  s1 =
    Te4[t1 >> 24] & 0xff000000 ^ Te4[t2 >> 16 & 0xff] & 0x00ff0000
      ^ Te4[t3 >> 8 & 0xff] & 0x0000ff00 ^ Te4[t0 & 0xff] & 0x000000ff
      ^ rk[1];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1018");
  (ct + 4)[0] = (u8) (s1 >> 24);
  __builtin_debug(6, "", 1);
  (ct + 4)[1] = (u8) (s1 >> 16);
  __builtin_debug(6, "", 1);
  ...
  (ct + 4)[3] = (u8) s1;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1019");
  s2 =
    Te4[t2 >> 24] & 0xff000000 ^ Te4[t3 >> 16 & 0xff] & 0x00ff0000
      ^ Te4[t0 >> 8 & 0xff] & 0x0000ff00 ^ Te4[t1 & 0xff] & 0x000000ff
      ^ rk[2];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1025");
  (ct + 8)[0] = (u8) (s2 >> 24);
  __builtin_debug(6, "", 1);
  (ct + 8)[1] = (u8) (s2 >> 16);
  __builtin_debug(6, "", 1);
  ...
  (ct + 8)[3] = (u8) s2;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1026");
  s3 =
    Te4[t3 >> 24] & 0xff000000 ^ Te4[t0 >> 16 & 0xff] & 0x00ff0000
      ^ Te4[t1 >> 8 & 0xff] & 0x0000ff00 ^ Te4[t2 & 0xff] & 0x000000ff
      ^ rk[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1032");
  (ct + 12)[0] = (u8) (s3 >> 24);
  __builtin_debug(6, "", 1);
  (ct + 12)[1] = (u8) (s3 >> 16);
  __builtin_debug(6, "", 1);
...
void rijndaelDecrypt(u32 const * rk, int Nr, u8 const * ct, u8 * pt)
{
  u32 s0;
  u32 s1;
  u32 s2;
  ...
  int r;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1036");
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  ...
  __builtin_debug(6, "", 1);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1038");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1045");
  s0 =
    (u32) ct[0] << 24 ^ (u32) ct[1] << 16 ^ (u32) ct[2] << 8 ^ (u32) ct[3]
      ^ rk[0];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1046");
  s1 =
    (u32) (ct + 4)[0] << 24 ^ (u32) (ct + 4)[1] << 16
      ^ (u32) (ct + 4)[2] << 8 ^ (u32) (ct + 4)[3] ^ rk[1];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1047");
  s2 =
    (u32) (ct + 8)[0] << 24 ^ (u32) (ct + 8)[1] << 16
      ^ (u32) (ct + 8)[2] << 8 ^ (u32) (ct + 8)[3] ^ rk[2];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1048");
  s3 =
    (u32) (ct + 12)[0] << 24 ^ (u32) (ct + 12)[1] << 16
      ^ (u32) (ct + 12)[2] << 8 ^ (u32) (ct + 12)[3] ^ rk[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1124");
  r = Nr >> 1;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1125");
  for (/*nothing*/; 1; /*nothing*/) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1126");
    t0 =
      Td0[s0 >> 24] ^ Td1[s3 >> 16 & 0xff] ^ Td2[s2 >> 8 & 0xff]
        ^ Td3[s1 & 0xff] ^ rk[4];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1132");
    t1 =
      Td0[s1 >> 24] ^ Td1[s0 >> 16 & 0xff] ^ Td2[s3 >> 8 & 0xff]
        ^ Td3[s2 & 0xff] ^ rk[5];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1138");
    t2 =
      Td0[s2 >> 24] ^ Td1[s1 >> 16 & 0xff] ^ Td2[s0 >> 8 & 0xff]
        ^ Td3[s3 & 0xff] ^ rk[6];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1144");
    t3 =
      Td0[s3 >> 24] ^ Td1[s2 >> 16 & 0xff] ^ Td2[s1 >> 8 & 0xff]
        ^ Td3[s0 & 0xff] ^ rk[7];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1151");
    rk += 8;
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1152");
    if (--r == 0) {
      break;
    }
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1156");
    s0 =
      Td0[t0 >> 24] ^ Td1[t3 >> 16 & 0xff] ^ Td2[t2 >> 8 & 0xff]
        ^ Td3[t1 & 0xff] ^ rk[0];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1162");
    s1 =
      Td0[t1 >> 24] ^ Td1[t0 >> 16 & 0xff] ^ Td2[t3 >> 8 & 0xff]
        ^ Td3[t2 & 0xff] ^ rk[1];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1168");
    s2 =
      Td0[t2 >> 24] ^ Td1[t1 >> 16 & 0xff] ^ Td2[t0 >> 8 & 0xff]
        ^ Td3[t3 & 0xff] ^ rk[2];
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1174");
    s3 =
      Td0[t3 >> 24] ^ Td1[t2 >> 16 & 0xff] ^ Td2[t1 >> 8 & 0xff]
        ^ Td3[t0 & 0xff] ^ rk[3];
  }
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1186");
  s0 =
    Td4[t0 >> 24] & 0xff000000 ^ Td4[t3 >> 16 & 0xff] & 0x00ff0000
      ^ Td4[t2 >> 8 & 0xff] & 0x0000ff00 ^ Td4[t1 & 0xff] & 0x000000ff
      ^ rk[0];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1192");
  pt[0] = (u8) (s0 >> 24);
  __builtin_debug(6, "", 1);
  pt[1] = (u8) (s0 >> 16);
  __builtin_debug(6, "", 1);
  ...
  pt[3] = (u8) s0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1193");
  s1 =
    Td4[t1 >> 24] & 0xff000000 ^ Td4[t0 >> 16 & 0xff] & 0x00ff0000
      ^ Td4[t3 >> 8 & 0xff] & 0x0000ff00 ^ Td4[t2 & 0xff] & 0x000000ff
      ^ rk[1];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1199");
  (pt + 4)[0] = (u8) (s1 >> 24);
  __builtin_debug(6, "", 1);
  (pt + 4)[1] = (u8) (s1 >> 16);
  __builtin_debug(6, "", 1);
  ...
  (pt + 4)[3] = (u8) s1;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1200");
  s2 =
    Td4[t2 >> 24] & 0xff000000 ^ Td4[t1 >> 16 & 0xff] & 0x00ff0000
      ^ Td4[t0 >> 8 & 0xff] & 0x0000ff00 ^ Td4[t3 & 0xff] & 0x000000ff
      ^ rk[2];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1206");
  (pt + 8)[0] = (u8) (s2 >> 24);
  __builtin_debug(6, "", 1);
  (pt + 8)[1] = (u8) (s2 >> 16);
  __builtin_debug(6, "", 1);
  ...
  (pt + 8)[3] = (u8) s2;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1207");
  s3 =
    Td4[t3 >> 24] & 0xff000000 ^ Td4[t2 >> 16 & 0xff] & 0x00ff0000
      ^ Td4[t1 >> 8 & 0xff] & 0x0000ff00 ^ Td4[t0 & 0xff] & 0x000000ff
      ^ rk[3];
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1213");
  (pt + 12)[0] = (u8) (s3 >> 24);
  __builtin_debug(6, "", 1);
  (pt + 12)[1] = (u8) (s3 >> 16);
  __builtin_debug(6, "", 1);
...
static void do_test_742(int keybits, u8 * key, u8 * plain, u8 * cipher,
                        int testno1, int testno2)
{
  ...
  int ok;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1408");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1409");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1410");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1411");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1413");
  nr = rijndaelKeySetupEnc(ckey, key, keybits);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1414");
  rijndaelEncrypt(ckey, nr, plain, temp);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1415");
  ok = memcmp(temp, cipher, 16) == 0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1416");
  printf("Encryption test %d %s\n", testno1, ok ? "passed" : "FAILED");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1417");
  nr = rijndaelKeySetupDec(ckey, key, keybits);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1418");
  rijndaelDecrypt(ckey, nr, cipher, temp);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1419");
  ok = memcmp(temp, plain, 16) == 0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1420");
  printf("Decryption test %d %s\n", testno2, ok ? "passed" : "FAILED");
}

static void do_bench_749(int nblocks)
{
  u32 ckey[60];
  u8 temp[16];
  int nr;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1425");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1426");
  temp[0] = 80;
  temp[1] = 108;
  temp[2] = 97;
  temp[3] = 105;
  ...
  temp[15] = 0;
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1427");
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1429");
  nr =
    rijndaelKeySetupEnc(ckey,
                        (u8 *) "\000\001\002\003\004\005\006\007\010\t\n\013\014\r\016\017",
                        128);
  __builtin_debug(6, "", 1);
  __builtin_debug(1, "#line:aes.c:1430");
  for (/*nothing*/; nblocks > 0; __builtin_debug(6, "", 1), nblocks--) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:aes.c:1431");
...
{
  __builtin_debug(6, "");
  __builtin_debug(1, "#line:aes.c:1436");
  do_test_742(128,
              (u8 *) "\000\001\002\003\004\005\006\007\010\t\n\013\014\r\016\017",
              (u8 *) "\000\021\"3DUfw\210\231\252\273\314\335\356\377",
              (u8 *) "i\304\340\330j{\0040\330\315\267\200p\264\305Z", 
              1, 2);
  __builtin_debug(6, "");
  __builtin_debug(1, "#line:aes.c:1441");
  do_test_742(192,
              (u8 *) "\000\001\002\003\004\005\006\007\010\t\n\013\014\r\016\017\020\021\022\023\024\025\026\027",
              (u8 *) "\000\021\"3DUfw\210\231\252\273\314\335\356\377",
              (u8 *) "\335\251|\244\206L\337\340n\257p\240\354\rq\221", 
              3, 4);
  __builtin_debug(6, "");
  __builtin_debug(1, "#line:aes.c:1446");
  do_test_742(256,
              (u8 *) "\000\001\002\003\004\005\006\007\010\t\n\013\014\r\016\017\020\021\022\023\024\025\026\027\030\031\032\033\034\035\036\037",
              (u8 *) "\000\021\"3DUfw\210\231\252\273\314\335\356\377",
              (u8 *) "\216\242\267\312QgE\277\352\374I\220KI`\211", 5, 
              6);
  __builtin_debug(6, "");
  __builtin_debug(1, "#line:aes.c:1451");
  do_bench_749(10000000);
  __builtin_debug(6, "");
  __builtin_debug(1, "#line:aes.c:1452");
  return 0;
  __builtin_debug(6, "");
  return 0;
}
