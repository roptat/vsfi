...
static double fade_1339(double t)
{
  __builtin_debug(6, "");
...
static double lerp_1344(double t, double a, double b)
{
  __builtin_debug(6, "");
...
static double grad_1350(int hash, double x, double y, double z)
{
  int h;
  double u;
  double v;
...
static double noise_1358(double x, double y, double z)
{
  int X;
  int Y;
  int Z;
  ...
  return lerp_1344(w,
                   lerp_1344(v,
                             ...
                             lerp_1344(u, grad_1350(p_1336[AB], x, y - 1, z),
                                       grad_1350(p_1336[BB], x - 1, y - 1, z))),
                   lerp_1344(v,
                             lerp_1344(u,
                                       grad_1350(p_1336[AA + 1], x, y, z - 1),
                                       grad_1350(p_1336[BA + 1], x - 1, 
                                                 y, z - 1)),
                             lerp_1344(u,
                                       grad_1350(p_1336[AB + 1], x, y - 1,
                                                 z - 1),
                                       grad_1350(p_1336[BB + 1], x - 1,
                                                 y - 1, z - 1))));
}
...
int main(int argc, char * * argv)
{
  ...
  for (__builtin_debug(6, "", 1), x = -11352.57E0;
       x < 23561.57E0;
       __builtin_debug(6, "", 1), x += 0.1235E0) {
    __builtin_debug(6, "", 1);
    __builtin_debug(1, "#line:perlin.c:69");
    for (__builtin_debug(6, "", 1), y = -346.1235E0;
         y < 124.124E0;
         __builtin_debug(6, "", 1), y += 1.4325E0) {
      __builtin_debug(6, "", 1);
      __builtin_debug(1, "#line:perlin.c:70");
      for (__builtin_debug(6, "", 1), z = -156.235E0;
           y < 23.2345E0;
           __builtin_debug(6, "", 1), y += 2.45E0) {
        __builtin_debug(6, "", 1);
