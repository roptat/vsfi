int crypto_auth(unsigned char *, unsigned char *, unsigned long long, unsigned char *);
...
int crypto_auth(unsigned char *out, unsigned char *in, unsigned long long inlen, unsigned char *k)
{
  ...
  int left;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:54"();
  v0 = 8317987319222330741LLU;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:55"();
  v1 = 7237128888997146477LLU;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:56"();
  v2 = 7816392313619706465LLU;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:57"();
  v3 = 8387220255154660723LLU;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:58"();
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:59"();
  k0 =
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:60"();
  k1 =
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:61"();
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:62"();
  end = in + inlen - inlen % sizeof(unsigned long long);
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:63"();
  left = inlen & 7;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:64"();
  b = (unsigned long long) inlen << 56;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:65"();
  v3 = v3 ^ k1;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:66"();
  v2 = v2 ^ k0;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:67"();
  v1 = v1 ^ k1;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:68"();
  v0 = v0 ^ k0;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:70"();
  for (;
       1;
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:72"();
    m =
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:80"();
    v3 = v3 ^ m;
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:81"();
    for (; 1; (void)0 /*nothing*/, ({ break; })) {
      builtin debug6 ""(1);
      v0 = v0 + v1;
      builtin debug6 ""(1);
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:82"();
    for (; 1; (void)0 /*nothing*/, ({ break; })) {
      builtin debug6 ""(1);
      v0 = v0 + v1;
      builtin debug6 ""(1);
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:83"();
    v0 = v0 ^ m;
  }
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:86"();
  switch (left) {
    case 7:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 6) << 48;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:90"();
    case 6:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 5) << 40;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:92"();
    case 5:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 4) << 32;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:94"();
    case 4:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 3) << 24;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:96"();
    case 3:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 2) << 16;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:98"();
    case 2:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 1) << 8;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:100"();
    case 1:
      builtin debug6 ""(1);
      b = b | (unsigned long long) *(in + 0);
      break;
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:102"();
    case 0:
      break;
    
  }
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:112"();
  v3 = v3 ^ b;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:113"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:114"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:115"();
  v0 = v0 ^ b;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:122"();
  v2 = v2 ^ 255;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:123"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:124"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:125"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:126"();
  for (; 1; (void)0 /*nothing*/, ({ break; })) {
    builtin debug6 ""(1);
    v0 = v0 + v1;
    builtin debug6 ""(1);
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:127"();
  b = v0 ^ v1 ^ v2 ^ v3;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:128"();
  ...
  *(out + 4 + 3) = (unsigned char) ((unsigned int) (b >> 32) >> 24);
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:129"();
  return 0;
}
...
int test_vectors(void)
{
  ...
  register int $219;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:215"();
  builtin debug6 ""(1);
  builtin debug6 ""(1);
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:216"();
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:217"();
  ok = 1;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:219"();
  builtin debug6 ""(1);
  i = 0;
  for (;
       1;
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:221"();
  builtin debug6 ""(1);
  i = 0;
  for (;
       1;
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:223"();
    *(in + i) = i;
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:224"();
    crypto_auth(out, in, i, k);
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:226"();
    $219 = memcmp(out, *(vectors + i), 8);
    if ($219) {
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:228"();
      printf(__stringlit_e080a4cd0de5f6c8783947b1a4554ec21, i);
      builtin debug6 ""(1);
      builtin debug1 "#line:siphash24.c:229"();
      ok = 0;
    }
  }
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:233"();
  return ok;
}
...
int speed_test(void)
{
  ...
  int i;
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:240"();
  builtin debug6 ""(1);
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:241"();
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:243"();
  builtin debug6 ""(1);
  i = 0;
  for (;
       1;
  ...
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:244"();
  builtin debug6 ""(1);
  i = 0;
  for (;
       1;
    ...
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:245"();
    *(testdata + 99) = (unsigned char) i;
    builtin debug6 ""(1);
    builtin debug1 "#line:siphash24.c:246"();
    crypto_auth(out, testdata, 100, k);
  }
  builtin debug6 ""(1);
  builtin debug1 "#line:siphash24.c:248"();
  return *(out + 0);
}
...
int main(void)
{
  ...
  register int $219;
  builtin debug6 ""();
  builtin debug1 "#line:siphash24.c:253"();
  $219 = test_vectors();
  if ($219) {
    builtin debug6 ""();
  ...
  builtin debug6 ""();
  builtin debug1 "#line:siphash24.c:254"();
  $220 = speed_test();
  builtin debug6 ""();
  builtin debug1 "#line:siphash24.c:255"();
  return 0;
  builtin debug6 ""();
  return 0;
}
